...
///   8. The "operands" directive specifies all the operands of an operation. It takes one argument
...
///  13. The "opdtypes" directive specifies all the operand types of an operation. It takes one
